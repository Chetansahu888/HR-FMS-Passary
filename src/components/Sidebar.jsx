...
const [afterLeavingOpen, setAfterLeavingOpen] = useState(false);
  ...
  { path: '/social-site', icon: User, label: 'Social Site' },
  ...
  { path: '/hod-verification', icon: UserCog, label: 'HR Verification' }, // alag icon
  {
    type: 'dropdown',
    icon: UserMinus,
    label: 'After Leaving Work',
    isOpen: afterLeavingOpen,
    toggle: () => setAfterLeavingOpen(!afterLeavingOpen),
    items: [
      { path: '/reporting-manager', label: 'Reporting Manager' },
      { path: '/it-department', label: 'IT Department' },
      { path: '/admin-department', label: 'Admin Department' },
      { path: '/account-department', label: 'Account Department' },
      { path: '/store-department', label: 'Store Department' }
    ]
  },
  ...
  { path: '/advance', icon: TrendingUp, label: 'Advance Report' },
  { path: '/deductions', icon: Receipt, label: 'Deductions Report' },
];
