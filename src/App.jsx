...
import Advance from './pages/Advance'; // ADD THIS IMPORT
import Deductions from './pages/Deductions'; // ADD THIS IMPORT
function App() {
  return (
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/" element={
            ...
            <Route path="deductions" element={<Deductions />} /> {/* ADD THIS ROUTE */}
