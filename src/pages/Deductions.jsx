...
const DeductionsReport = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch('https://script.google.com/macros/s/AKfycbyPX2PreyvGFcx8V5Jv7R2TwZgMOiEzCKSKntbTzy1ElMSvmgiWCJ1O_CHG6DStW48hlQ/exec?sheet=Deductions&action=fetch');
