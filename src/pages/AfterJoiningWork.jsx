...
const AfterJoiningWork = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    manualImageUrl: "",
    assets: [],
    incentiveCategory: "", // New field for Incentive Category
  });
    ...
    try {
      ...
      const processedData = dataRows.map((row, idx) => {
        const item = {
          ...
          incentiveCategory: row[91] || "",   // AZ - New column for Incentive Category
        };
  ...
  const handleAfterJoiningClick = async (item) => {
    ...
    try {
      ...
      setFormData({
        employeeCode: newEmployeeCode, // Auto-filled here
        salaryConfirmation: "",
        salaryAmount: "",
        reportingOfficer: "",
        pf: "",
      ...
      if (rowIndex === -1) {
        ...
        const finalFormData = {
          ...
          joiningLetter: null,
          manualImage: null,
          incentiveCategory: assetsData?.incentiveCategory || "", // Load incentive category
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updates = [
        ...
        { col: 91, val: formData.incentiveCategory || "" },           // AY (Column 91) - New: Incentive Category
      ];
